...
// browsing data for that profile. This intercession macro allows Brave to
// additionally call its own data clearing routine for the profile before it
// is unloaded.
#define BRAVE_PROFILE_MANAGER_ON_BROWSER_CLOSED \
  content::BraveClearBrowsingData::ClearOnBrowserClosed(profile);
