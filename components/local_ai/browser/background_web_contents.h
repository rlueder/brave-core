...
#ifndef BRAVE_COMPONENTS_LOCAL_AI_BROWSER_BACKGROUND_WEB_CONTENTS_H_
#define BRAVE_COMPONENTS_LOCAL_AI_BROWSER_BACKGROUND_WEB_CONTENTS_H_
 ...
 public:
  class Delegate {
   public:
    ...
    // Called when the background WebContents is destroyed (renderer crash
    // or window.close()).
...
#endif  // BRAVE_COMPONENTS_LOCAL_AI_BROWSER_BACKGROUND_WEB_CONTENTS_H_
